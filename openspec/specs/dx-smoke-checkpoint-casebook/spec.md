# dx-smoke-checkpoint-casebook Specification

## Purpose
Defines device smoke coverage for policy checkpoint save, mutation, restore, and runtime epoch cleanup behavior.
