...
OUTPUT_PATH="${DEV_IPTEST_RAW_PROTO_OUTPUT_PATH:-$SNORT_ROOT/build-output/iptest-raw-proto}"
SRC_PATH="${DEV_IPTEST_RAW_PROTO_SOURCE_PATH:-$SNORT_ROOT/tests/device/ip/native/iptest_raw_proto.cpp}"
