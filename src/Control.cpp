...
void Control::cmdHelp(CmdParams &&params) const {
    params.out
        ...
        << "***\r\n"
        << "\r\n"
        << "BLOCKIPLEAKS [<0|1>]: frozen/no-op (effective: 0). Set returns OK but has no effect.\r\n"
        << "GETBLACKIPS [<0|1>]: frozen/no-op (effective: 0). Set returns OK but has no effect.\r\n"
        << "MAXAGEIP [<int>]: frozen/no-op (effective: 14400). Set returns OK but has no effect.\r\n"
        << "    Use vNext control via sucre-snort-ctl (sucre-snort-control-vnext / port 60607).\r\n"
        << "\r\n"
