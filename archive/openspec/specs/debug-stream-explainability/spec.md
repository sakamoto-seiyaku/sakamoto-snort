# debug-stream-explainability Specification

## Purpose
Define vNext Debug Stream per-event explainability for tracked DNS and packet events without expanding normal telemetry, metrics, or history surfaces.
