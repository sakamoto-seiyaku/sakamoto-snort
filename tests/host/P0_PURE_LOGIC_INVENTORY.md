...
- `PackageState`
  - 文档依据：`docs/NATIVE_DEBUGGING_AND_TESTING.md`、`openspec/specs/multi-user-support/spec.md`
...
- `Stats` / `AppStats` / `DomainStats`
  - 文档依据：`docs/NATIVE_DEBUGGING_AND_TESTING.md`、`openspec/project.md`、`docs/INTERFACE_SPECIFICATION.md`
...
- `CustomRules`
  - 文档依据：`docs/NATIVE_DEBUGGING_AND_TESTING.md`、`docs/DOMAIN_POLICY_OBSERVABILITY.md`
...
- `Control` 参数解析辅助逻辑
  - 文档依据：`docs/NATIVE_DEBUGGING_AND_TESTING.md`、`openspec/specs/multi-user-support/spec.md`、`docs/INTERFACE_SPECIFICATION.md`
...
- `P1/P2/P3` 不吸收这些 pure-logic 责任；后续 phases 仅补集成验证、真机 smoke 与真机调试链路。
