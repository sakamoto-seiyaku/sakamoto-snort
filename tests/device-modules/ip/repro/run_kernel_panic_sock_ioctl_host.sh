...
records_dir="$SNORT_ROOT/tests/device-modules/ip/records"
...
adb_push_file "$SNORT_ROOT/tests/device-modules/ip/repro/kernel_panic_sock_ioctl_device_repro.sh" "$remote_path" >/dev/null
